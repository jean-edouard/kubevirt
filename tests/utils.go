...
func NewRandomVMIWithSecureBoot() *v1.VirtualMachineInstance {
	vmi := NewRandomVMIWithEphemeralDiskHighMemory(ContainerDiskFor(ContainerDiskFedoraCoreOS))
...
const (
	...
	ContainerDiskFedoraCoreOS         ContainerDisk = "fedora-coreos"
...
func ContainerDiskFor(name ContainerDisk) string {
	switch name {
	case ContainerDiskCirros, ContainerDiskAlpine, ContainerDiskFedora, ContainerDiskFedoraCoreOS, ContainerDiskCirrosCustomLocation:
