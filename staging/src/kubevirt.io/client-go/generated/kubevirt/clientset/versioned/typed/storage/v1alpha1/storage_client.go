...
type StorageV1alpha1Interface interface {
	...
	StorageMigrationsGetter
}

// StorageV1alpha1Client is used to interact with features provided by the storage.kubevirt.io group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) StorageMigrations(namespace string) StorageMigrationInterface {
	return newStorageMigrations(c, namespace)
}
