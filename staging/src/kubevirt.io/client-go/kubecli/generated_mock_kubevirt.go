...
func (_m *MockKubevirtClient) StorageMigration(namespace string) v1alpha114.StorageMigrationInterface {
	ret := _m.ctrl.Call(_m, "StorageMigration", namespace)
	ret0, _ := ret[0].(v1alpha114.StorageMigrationInterface)
	return ret0
}

func (_mr *_MockKubevirtClientRecorder) StorageMigration(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "StorageMigration", arg0)
}
