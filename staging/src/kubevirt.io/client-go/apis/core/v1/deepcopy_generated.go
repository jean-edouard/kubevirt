...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in NetworkRoles) DeepCopyInto(out *NetworkRoles) {
	{
		in := &in
		*out = make(NetworkRoles, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkRoles.
func (in NetworkRoles) DeepCopy() NetworkRoles {
	if in == nil {
		return nil
	}
	out := new(NetworkRoles)
	in.DeepCopyInto(out)
	return *out
}
