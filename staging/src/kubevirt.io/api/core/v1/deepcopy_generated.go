...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackendStorageStatus) DeepCopyInto(out *BackendStorageStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendStorageStatus.
func (in *BackendStorageStatus) DeepCopy() *BackendStorageStatus {
	if in == nil {
		return nil
	}
	out := new(BackendStorageStatus)
	in.DeepCopyInto(out)
	return out
}
