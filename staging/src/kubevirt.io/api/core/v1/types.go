...
const (
	...
	// This annotation represents the alternative PVC to use for backend storage (used by snapshot restore)
	BackendStoragePVCAnnotation = "kubevirt.io/backend-storage-pvc"
