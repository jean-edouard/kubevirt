...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostDevicesList) DeepCopyInto(out *HostDevicesList) {
	*out = *in
	if in.AddrList != nil {
		in, out := &in.AddrList, &out.AddrList
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostDevicesList.
func (in *HostDevicesList) DeepCopy() *HostDevicesList {
	if in == nil {
		return nil
	}
	out := new(HostDevicesList)
	in.DeepCopyInto(out)
	return out
}
