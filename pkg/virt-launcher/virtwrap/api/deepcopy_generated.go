...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SingleVCPU) DeepCopyInto(out *SingleVCPU) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleVCPU.
func (in *SingleVCPU) DeepCopy() *SingleVCPU {
	if in == nil {
		return nil
	}
	out := new(SingleVCPU)
